...
const bsp_io_10_t IO_SENSOR[] = {
     { IO_SENSOR_0 , RISING_EDGE  }
    ,{ IO_SENSOR_1 , RISING_EDGE  }
    ,{ IO_SENSOR_2 , RISING_EDGE  }
    ,{ IO_SENSOR_3 , RISING_EDGE  }
    ,{ IO_SENSOR_4 , RISING_EDGE  }
    ,{ IO_SENSOR_5 , RISING_EDGE  }
    ,{ IO_SENSOR_6 , RISING_EDGE  }
    ,{ IO_SENSOR_7 , RISING_EDGE  }
    ,{ IO_SENSOR_8 , RISING_EDGE  }
    ,{ IO_SENSOR_9 , RISING_EDGE  }
    ,{ IO_SENSOR_10, RISING_EDGE  }
    ,{ IO_SENSOR_11, RISING_EDGE  }
    ,{ IO_SENSOR_12, RISING_EDGE  }
    ,{ IO_SENSOR_13, RISING_EDGE  }
    ,{ IO_SENSOR_14, RISING_EDGE  }
    ,{ IO_SENSOR_15, RISING_EDGE  }
    ,{ IO_SENSOR_16, RISING_EDGE  }
    ,{ IO_SENSOR_17, RISING_EDGE  }
    ,{ IO_SENSOR_18, RISING_EDGE  }
    ,{ IO_SENSOR_19, RISING_EDGE  }
    ,{ IO_SENSOR_20, RISING_EDGE  }
    ,{ IO_SENSOR_21, RISING_EDGE  }
    ,{ IO_SENSOR_22, RISING_EDGE  }
    ,{ IO_SENSOR_23, RISING_EDGE  }
    ,{ IO_SENSOR_24, RISING_EDGE  }
    ,{ IO_SENSOR_25, RISING_EDGE  }
    ,{ IO_SENSOR_26, RISING_EDGE  }
    ,{ IO_SENSOR_27, RISING_EDGE  }
