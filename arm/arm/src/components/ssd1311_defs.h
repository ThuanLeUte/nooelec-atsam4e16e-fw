...
static const ssd1311_function_t SSD1311_CFG_SCRIPT[] =
{
  ...
  ,SSD1311_INFO(SSD1311_DELAY, 100)

  ,SSD1311_INFO(SSD1311_CMD,  0x2A)
  ,SSD1311_INFO(SSD1311_CMD,  0x71)
  ,SSD1311_INFO(SSD1311_CMD,  0x5C)
